        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', fontSize: '0.73rem', fontWeight: 600, color: 'var(--text-secondary)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              ...
              <span style={{ color: 'var(--accent-amber)' }}>Overloaded / Degraded</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          {(() => {
            const linesData = [
              ...
              // TL1: S1 -> S2
              {
                ...
                color: isS2Degraded ? 'var(--accent-amber)' : (tl1.online && s2.online ? 'var(--accent-emerald)' : 'var(--accent-rose)'),
              ...
              // TL4: S2 -> S3 (Critical Overload Target)
              {
                ...
                color: isS2Degraded || isTl4Overloaded ? 'var(--accent-amber)' : (s2.online && tl4.online ? 'var(--accent-emerald)' : 'var(--accent-rose)'),
              ...
              // B1 Storage Feed -> S2
              {
                ...
                color: 'var(--brand-mind, var(--accent-purple))',
